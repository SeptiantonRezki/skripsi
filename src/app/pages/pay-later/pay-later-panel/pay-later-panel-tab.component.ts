...
@Component({
  selector: 'app-pay-later-panel-tab',
  templateUrl: './pay-later-panel-tab.component.html',
  styleUrls: ['./pay-later-panel-tab.component.scss']
})
export class PayLaterPanelTabComponent implements OnInit {
  selectedTab: any;
