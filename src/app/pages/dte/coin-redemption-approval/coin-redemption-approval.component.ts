...
@Component({
  selector: 'app-coin-redemption-approval',
  templateUrl: './coin-redemption-approval.component.html'
})
export class CoinRedemptionApprovalComponent implements OnInit {
  url = '';
  ...
  constructor(
    ...
    this.permission = this.roles.getArrayRoles('principal.dtecoinredemptionapproval');
