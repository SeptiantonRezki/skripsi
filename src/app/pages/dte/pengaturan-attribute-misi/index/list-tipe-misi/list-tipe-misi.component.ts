...
@Component({
  ...
  templateUrl: './list-tipe-misi.component.html',
  styleUrls: ['./list-tipe-misi.component.scss']
})
export class ListTipeMisiComponent implements OnInit {
  dialogTipeMisiDialogRef: MatDialogRef<DialogTipeMisiComponent>;
  dialogTipeMisiEditDialogRef: MatDialogRef<DialogTipeMisiEditComponent>;
  ...
  constructor(
   ...
   openDialogTipeMisi() {
    this.dialogTipeMisiDialogRef = this.Dialog.open(DialogTipeMisiComponent, {
      width: "300px",
    });

    this.dialogTipeMisiDialogRef
      .afterClosed()
  ...
  confirmDeleteTipeMisi() {
    this.pengaturanAttributeMisiService.deleteTipeMisi({ tipe_misi_id: this.id }).subscribe(res => {
