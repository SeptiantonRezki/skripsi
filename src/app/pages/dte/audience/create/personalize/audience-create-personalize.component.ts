...
export class AudienceCreatePersonalizeComponent implements OnInit {
  ...
  // TODO: radio
  chooseGetAudience: any[] = [
    { name: "Population Blast", value: "tsm" },
    { name: "Recommended Panel", value: "scheduler" },
  ];
  tsmScheduler: any[] = [
    { name: "TSM", value: "tsm" },
  ...
  public radioFixed: FormControl = new FormControl();
  listPublishMisi: any[];
  ...
  tsmOrScheduler(value) {
    this.formAudience.get('audience_type').setValue(value);
    if (value !== 'fixed') {
      this.radioFixed.setValue('');
    }
  }
