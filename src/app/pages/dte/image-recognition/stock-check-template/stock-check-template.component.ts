...
@Component({
  selector: 'app-stock-check-template',
  templateUrl: './stock-check-template.component.html'
})
export class StockCheckTemplateComponent implements OnInit {
  url = '';
  ...
  constructor(
    ...
    this.permission = this.roles.getArrayRoles('principal.dte_image_recognition_master_brand');
