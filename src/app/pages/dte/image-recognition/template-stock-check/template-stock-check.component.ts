...
@Component({
  selector: 'app-template-stock-check',
  templateUrl: './template-stock-check.component.html'
})
export class TemplateStockCheckComponent implements OnInit {
  url = '';
  ...
  constructor(
    ...
    this.permission = this.roles.getArrayRoles('principal.dte_image_recognition_stock_check');
