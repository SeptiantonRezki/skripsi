...
@Component({
  selector: 'app-template-planogram',
  templateUrl: './template-planogram.component.html',
})
export class TemplatePlanogramComponent implements OnInit {
  url = '';
  ...
  constructor(
    ...
    this.permission = this.roles.getArrayRoles('principal.dte_image_recognition_planogram');
