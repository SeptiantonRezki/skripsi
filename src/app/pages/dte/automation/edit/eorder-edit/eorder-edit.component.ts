...
@Component({
  ...
  templateUrl: './eorder-edit.component.html',
  styleUrls: ['./eorder-edit.component.scss']
})
export class EOrderEditComponent implements OnInit {
  // For chips
  visible = true;
  selectable = true;
  removable = true;
  ...
  ngOnInit() {
    ...
    this.formTemp.setValue({
      sku: (this.detailAutomation.type === "e-order" && !!this.detailAutomation.sku_id) ? this.detailAutomation.sku_id : [],
      startDate: this.detailAutomation.start_date,
