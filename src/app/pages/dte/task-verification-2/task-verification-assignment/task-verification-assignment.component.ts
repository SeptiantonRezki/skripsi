...
@Component({
  selector: 'app-task-verification-assignment',
  templateUrl: './task-verification-assignment.component.html',
})
export class TaskVerificationAssignmentComponent implements OnInit {
  url = '';
  ...
  constructor(
    ...
    this.permission = this.roles.getArrayRoles('principal.dteverificationassignment');
