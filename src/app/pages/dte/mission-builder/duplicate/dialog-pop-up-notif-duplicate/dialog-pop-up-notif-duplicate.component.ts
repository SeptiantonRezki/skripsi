...
@Component({
  selector: 'app-dialog-pop-up-notif-duplicate',
  templateUrl: './dialog-pop-up-notif-duplicate.component.html',
  styleUrls: ['./dialog-pop-up-notif-duplicate.component.scss']
})
export class DialogPopUpNotifDuplicateComponent implements OnInit {
