...
@Component({
  selector: 'app-dialog-waktu-tunggu-duplicate',
  templateUrl: './dialog-waktu-tunggu-duplicate.component.html',
  styleUrls: ['./dialog-waktu-tunggu-duplicate.component.scss']
})
export class DialogWaktuTungguDuplicateComponent implements OnInit {

  form: FormGroup;

  constructor(
    private formBuilder: FormBuilder,
    public dialogRef: MatDialogRef<DialogWaktuTungguDuplicateComponent>,
