...
@Component({
  selector: 'app-diaglog-push-notif',
  templateUrl: './diaglog-push-notif.component.html',
  styleUrls: ['./diaglog-push-notif.component.scss']
})
export class DiaglogPushNotifComponent implements OnInit {
  form: FormGroup;
  pushNotif: any[];
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DiaglogPushNotifComponent>,
