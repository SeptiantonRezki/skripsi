...
@Component({
  ...
  templateUrl: './mission-builder-create.component.html',
  styleUrls: ['./mission-builder-create.component.scss']
})
export class MissionBuilderCreateComponent implements OnInit {

  dialogMisiRef: MatDialogRef<DiaglogMisiComponent>;
  dialogPopUpNotificationRef: MatDialogRef<DiaglogPopUpNotifComponent>;
  dialogPushNotificationRef: MatDialogRef<DiaglogPushNotifComponent>;
  dialogWaktuTungguRef: MatDialogRef<DiaglogWaktuTungguComponent>;
  dialogYesNo: MatDialogRef<DialogYesNoComponent>;
  dialogCoinRef: MatDialogRef<DialogCoinComponent>;
  ...
  checkBudget() {
    ...
    this.sequencingService.checkBudget(body).subscribe(res => {
      ...
      this.task.total_budget = this.budget;
    }, err => {
      console.log('err', err);
      this.dataService.showLoading(false);
    })
  ...
  openDialogPopUp(node: any) {
    this.dialogPopUpNotificationRef = this.Dialog.open(
      DiaglogPopUpNotifComponent, { width: "600px", data: node }
    );
  ...
  openDialogPushNotif(node: any) {
    this.dialogPushNotificationRef = this.Dialog.open(
      DiaglogPushNotifComponent, { width: "600px", data: node }
    );
  ...
  openDialogWaktuTunggu(node: any) {
    this.dialogWaktuTungguRef = this.Dialog.open(
      DiaglogWaktuTungguComponent, { width: "600px", data: node }
    );
  ...
  openDialogCoin(node: any) {
    this.dialogCoinRef = this.Dialog.open(
      DialogCoinComponent, { width: "600px", data: node }
    );
