...
@Component({
  selector: 'app-dialog-waktu-tunggu-edit',
  templateUrl: './dialog-waktu-tunggu-edit.component.html',
  styleUrls: ['./dialog-waktu-tunggu-edit.component.scss']
})
export class DialogWaktuTungguEditComponent implements OnInit {

  form: FormGroup;

  constructor(
    private formBuilder: FormBuilder,
    public dialogRef: MatDialogRef<DialogWaktuTungguEditComponent>,
