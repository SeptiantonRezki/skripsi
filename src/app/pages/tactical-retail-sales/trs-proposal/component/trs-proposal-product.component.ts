...
@Component({
  templateUrl: './trs-proposal-product.component.html',
  styleUrls: ['./trs-proposal-product.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class TrsProposalProductComponent {
  ...
  constructor(
    public dialogRef: MatDialogRef<TrsProposalProductComponent>,
