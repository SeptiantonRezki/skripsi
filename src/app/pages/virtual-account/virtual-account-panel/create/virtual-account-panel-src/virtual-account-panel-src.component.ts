...
@Component({
  ...
  templateUrl: './virtual-account-panel-src.component.html',
  styleUrls: ['./virtual-account-panel-src.component.scss']
})
export class VirtualAccountPanelSrcComponent implements OnInit, OnDestroy {
  ...
  // getCourerList() {
  //   this.panelService.courierList().subscribe(res => {
  //     console.log('res', res);
  ...
  //   this.panelService.courierServiceList({ courier_id: courierID }).subscribe(res => {
