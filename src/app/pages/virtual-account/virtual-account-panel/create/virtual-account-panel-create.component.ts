...
@Component({
  selector: 'app-virtual-account-panel-create',
  templateUrl: './virtual-account-panel-create.component.html',
  styleUrls: ['./virtual-account-panel-create.component.scss']
})
export class VirtualAccountPanelCreateComponent implements OnInit, OnDestroy {
  selectedTab: any;
