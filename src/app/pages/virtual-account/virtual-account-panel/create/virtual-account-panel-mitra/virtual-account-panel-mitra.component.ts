...
@Component({
  ...
  templateUrl: './virtual-account-panel-mitra.component.html',
  styleUrls: ['./virtual-account-panel-mitra.component.scss']
})
export class VirtualAccountPanelMitraComponent implements OnInit, OnDestroy {
