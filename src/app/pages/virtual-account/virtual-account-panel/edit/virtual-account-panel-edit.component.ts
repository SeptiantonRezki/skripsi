...
@Component({
  selector: 'app-virtual-account-panel-edit',
  templateUrl: './virtual-account-panel-edit.component.html',
  styleUrls: ['./virtual-account-panel-edit.component.scss']
})
export class VirtualAccountPanelEditComponent implements OnInit {
  selectedTab: any;
  ...
  constructor(
    ...
    // const selectedTab = dataService.getFromStorage("selected_tab_virtual_account_panel");
  ...
  setSelectedTab(tabChangeEvent: MatTabChangeEvent) {
    ...
    this.dataService.setToStorage("selected_tab_virtual_account_panel", this.selectedTab);
  }
