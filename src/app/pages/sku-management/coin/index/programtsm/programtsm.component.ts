...
@Component({
  selector: 'app-programtsm',
  templateUrl: './programtsm.component.html',
  styleUrls: ['./programtsm.component.scss']
})
export class ProgramtsmComponent implements OnInit {
  ...
  confirmFlush() {
    ...
    this.coinService.flushtsm(body).subscribe(
      res => {
