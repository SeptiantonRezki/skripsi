...
@Component({
  selector: 'app-tsm-import-adjustmen-coin-dialog',
  templateUrl: './tsm-import-adjustmen-coin-dialog.component.html',
  styleUrls: ['./tsm-import-adjustmen-coin-dialog.component.scss']
})
export class TsmImportAdjustmenCoinDialogComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<TsmImportAdjustmenCoinDialogComponent>,
  ...
  submit() {
    if (this.rows.length > 0) {
      ...
      let parameter = "tsm";
      this.sequencingService.adjustRetailerCoin({body, from : parameter})
        .subscribe(res => {
