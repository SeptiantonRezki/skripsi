...
@Component({
  selector: 'app-pembayaran-benefit-program',
  templateUrl: './pembayaran-benefit-program.component.html',
  styleUrls: ['./pembayaran-benefit-program.component.scss']
})
export class PembayaranBenefitProgramComponent implements OnInit {
  url = '';
  ...
  constructor(
    ...
    this.permission = this.roles.getArrayRoles('principal.pembayaranbenefitprogram');
