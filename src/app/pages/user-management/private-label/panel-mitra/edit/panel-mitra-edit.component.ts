      ...
      this.panelMitraService.detail({ panelMitraId: this.panelMitraId }).subscribe(
        res => {
          if (res.status == 'success') {
            this.panelMitraDetail = res.data.data;
            this.formInput.get('filterproduct').setValue(res.data.data.product_id);
            this.formInput.get('filtersupplier').setValue(res.data.data.supplier_company_id);
          } else {
