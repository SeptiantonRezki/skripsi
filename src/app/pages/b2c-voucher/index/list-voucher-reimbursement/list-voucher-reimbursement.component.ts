...
@Component({
  ...
  templateUrl: './list-voucher-reimbursement.component.html',
  styleUrls: ['./list-voucher-reimbursement.component.scss']
})
export class ListVoucherReimbursementComponent implements OnInit {
  onLoad: boolean;
  detailVoucher: any;
  ...
  getListReimbursement(string?: any) {
  ...
  async exportListReimbursement() {
    this.dataService.showLoading(true);
    try {
      const response = await this.b2cVoucherService.exportListReimbursement().toPromise();
