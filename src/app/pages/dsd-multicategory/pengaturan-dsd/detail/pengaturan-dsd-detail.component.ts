...
@Component({
  selector: 'app-pengaturan-dsd-detail',
  templateUrl: './pengaturan-dsd-detail.component.html',
  styleUrls: ['./pengaturan-dsd-detail.component.scss']
})
export class PengaturanDsdDetailComponent implements OnInit {
