  ...
  getUrl(namespace, key, context) {
     ...
     const ENDPOINT = {
      ...
      authentication: {
		...
		store_user: `${AYO_API}/api/wholesaler/user`,
		//login: `${AYO_API}/oauth/token` ,
		login: `${AYO_API}/api/wholesaler/token`,
	  ...
	  retailer: {
		  list_level: `${AYO_API}/api/wholesaler/level`,
		  list_shipping: `${AYO_API}/api/wholesaler/shipping`,
		  create: `${AYO_API}/api/wholesaler/retailer`,
		  get: `${AYO_API}/api/wholesaler/retailer`,
		  deactivate: `${AYO_API}/api/wholesaler/${context.retailer_id}/deactivate`,
		  update: `${AYO_API}/api/wholesaler/retailer/${context.retailer_id}`
	  }
