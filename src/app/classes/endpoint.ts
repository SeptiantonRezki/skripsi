...
export class Endpoint {
  getUrl(namespace, key, context) {
    ...
    const ENDPOINT = {
      ...
      info_board: {
        get: `${AYO_API_SERVICE(SERVER.business)}/api/v1/${type_api}/info-board`,
        detail: `${AYO_API_SERVICE(SERVER.business)}/api/v1/${type_api}/info-board/${context.id}`,
        create: `${AYO_API_SERVICE(SERVER.business)}/api/v1/${type_api}/info-board`,
        put: `${AYO_API_SERVICE(SERVER.business)}/api/v1/${type_api}/info-board/update/${context.id}`,
        put_audience: `${AYO_API_SERVICE(SERVER.business)}/api/v1/${type_api}/info-board/update-audience/${context.id}`,
        delete: `${AYO_API_SERVICE(SERVER.business)}/api/v1/${type_api}/info-board/${context.id}`,
