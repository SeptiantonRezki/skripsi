  ...
  getUrl(namespace, key, context) {
    ...
    const ENDPOINT = {
      ...
      product_submission: {
        ...
        put_approver_1: `${AYO_API_SERVICE(SERVER.product)}/api/v1/product/principal/submissions/db-product/${context.product_id}/approver-1`,
        put_disapprover_1: `${AYO_API_SERVICE(SERVER.product)}/api/v1/product/principal/submissions/db-product/${context.product_id}/disapprover-1`,
        put_approver_db_product: `${AYO_API_SERVICE(SERVER.product)}/api/v1/product/principal/submissions/db-product/${context.product_id}/approver-produk-db`,
        put_disapprover_db_product: `${AYO_API_SERVICE(SERVER.product)}/api/v1/product/principal/submissions/db-product/${context.product_id}/disapprover-produk-db`,
