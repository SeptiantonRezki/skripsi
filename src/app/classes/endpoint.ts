  ...
  getUrl(namespace, key, context) {
    ...
    const ENDPOINT = {
      ...
      PLStock: {
        ...
        get_table: `${AYO_API_SERVICE(SERVER.product)}/api/v1/product/principal/geotree/product`,
        check: `${AYO_API_SERVICE(SERVER.product)}/api/v1/product/principal/geotree/product/check`,
