...
export class Endpoint {
  getUrl(namespace, key, context) {
    ...
    const ENDPOINT = {
      ...
      wholesaler: {
        get: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/wholesaler`,
        create: `${AYO_API_SERVICE(SERVER.business)}/api/v1/business/principal/wholesaler`,
        show: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/wholesaler/${context.wholesaler_id}`,
        put: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/wholesaler/${context.wholesaler_id}`,
        ...
        export: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/wholesaler/export/data?area=${context.area_id}`,
        ...
        show_ktp: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/wholesaler/show-ktp`,
        show_npwp: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/wholesaler/show-npwp`,
      ...
      wholesaler_special_price: {
        get: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/product/special-price/list-mitra`,
        create: `${AYO_API_SERVICE(SERVER.business)}/api/v1/business/principal/wholesaler`,
        ...
        exportWholesaller: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/product/special-price/list-mitra-export`,
        import_preview: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/product/special-price/list-mitra-preview`,
        store_import: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/product/special-price/list-mitra-import`,
        // roles: `http://demo6191696.mockable.io/api/v1/business/principal/wholesaler/tingkat-fitur`,
        roles: `${AYO_API_SERVICE(SERVER.user)}/api/v1/user/principal/feature-level/wholesaler/list`
      },
      retailer: {
        get: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/retailer`,
        show: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/retailer/${context.retailer_id}`,
        create: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/retailer`,
        ...
        export_access_cashier: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/retailer/export`,
        export_id_number: `${AYO_API_SERVICE(SERVER.business)}/api/v1/business/principal/retailer/export-id-number`,
        import_access_cashier: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/retailer/preview`,
        store_access_cashier: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/retailer/flag-cashier`,
      ...
      pengajuan_src: {
        get: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/pengajuan-src`,
        show: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/pengajuan-src/${context.pengajuan_id}`,
        create: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/pengajuan-src`,
        put: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/pengajuan-src/${context.pengajuan_id}`,
        delete: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/pengajuan-src/${context.pengajuan_id}`,
        update_status: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/pengajuan-src/update-status/${context.pengajuan_id}`,
        list_product: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/pengajuan-src/list/product`,
        list_source: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/pengajuan-src/list/source`,
        list_channel: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/pengajuan-src/list/channel`,
        export: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/pengajuan-src/export/data`,
      ...
      banner: {
        ...
        import_audience: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/general/business/list-audiences/import`,
      ...
      audience: {
        ...
        list_retailer: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/dte/get-all-audience`,
        ...
        list_children: `${AYO_API_SERVICE(SERVER.area)}/api/v1/general/area/by-level/${context.level_desc}`,
        list_other_children: `${AYO_API_SERVICE(SERVER.area)}/api/v1/general/area/children/${context.parent_id}`,
        // import: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/dte/import-audience`,
        ...
        // export: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/dte/export-audience`,
      ...
      tnc: {
        ...
        company_list: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/paylater/group`
      },
      privacy: {
      ...
      coin: {
        ...
        retailer: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/dte/get-business-coin`,
        ...
        export: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/dte/export-coin`,
      ...
      general: {
        ...
        get_business: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/general/business/get/${context.business_id}`,
        list_level: `${AYO_API_SERVICE(SERVER.area)}/api/v1/general/area/level`,
        list_children: `${AYO_API_SERVICE(SERVER.area)}/api/v1/general/area/by-level/${context.level_desc}`,
        list_other_children: `${AYO_API_SERVICE(SERVER.area)}/api/v1/general/area/children/${context.parent_id}`,
      ...
      PLSupplierCompany: {
        ...
        getListByProductId: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/private-label/supplier-company-list?product_id=${context.productId}&search=${context.value}`,
        detail: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/private-label/supplier-company/${context.supplierId}`,
        create: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/private-label/supplier-company`,
        update: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/private-label/supplier-company/${context.supplierId}`,
        updateStatus: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/private-label/supplier-company/${context.supplierId}?type=status`,
        delete: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/private-label/supplier-company/${context.supplierId}`,
      ...
      PLSupplierPanelMitra: {
        getList: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/private-label/supplier-panel-mitra`,
        getListMitra: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/private-label/supplier-list-mitra`,
        detail: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/private-label/supplier-panel-mitra/${context.panelMitraId}`,
        create: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/private-label/supplier-panel-mitra`,
        update: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/private-label/supplier-panel-mitra/${context.panelMitraId}`,
        delete: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/private-label/supplier-panel-mitra/${context.panelMitraId}`,
        ...
        list_other_children: `${AYO_API_SERVICE(SERVER.area)}/api/v1/general/area/children/${context.parent_id}`,
        filterSupplier: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/general/private-label/supplier-company-by-product-id/${context.productId}`,
        importMitra: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/private-label/supplier-import-mitra`,
        exportMitra: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/private-label/supplier-export-mitra`,
        previewImportMitra: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/private-label/supplier-preview-mitra`,
        checkPanelMitra: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/private-label/check-panel-mitra`,
        export_supplier_panel_mitra: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/private-label/supplier-panel-mitra/${context.id}/export`
      },
      PLOrdertoSupplier: {
      ...
      courier: {
        get: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/delivery/courier`,
        show: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/delivery/courier/${context.courier_id}`,
        create: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/delivery/courier`,
        update: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/delivery/courier/${context.courier_id}`,
        delete: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/delivery/courier/${context.courier_id}`,
        update_status: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/delivery/courier/update-status/${context.courier_id}`
      },
      mitra_panel: {
        get: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/delivery/panel-mitra`,
        show: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/delivery/panel-mitra/${context.panel_id}`,
        create: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/delivery/panel-mitra`,
        update: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/delivery/panel-mitra`,
        delete: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/delivery/panel-mitra/${context.panel_id}`,
        mitra_list: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/delivery/panel-mitra/mitra/list?area=${context.area_id ? context.area_id : 1}`,
        courier_service: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/delivery/panel-mitra/courier-service/${context.courier_id}`,
        courier_list: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/delivery/panel-mitra/courier/list`,
        import: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/delivery/panel-mitra/mitra/import`,
        preview_import: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/delivery/panel-mitra/mitra/preview-import`,
        export: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/delivery/panel-mitra/mitra/export`,
        check_mitra: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/delivery/panel-mitra/mitra/check`
      },
      store_template_layout: {
        get: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/vendor/layout-template`,
        create: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/vendor/layout-template`,
        show: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/vendor/layout-template/${context.layout_id}`,
        update: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/vendor/layout-template/${context.layout_id}`,
        delete: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/vendor/layout-template/${context.layout_id}`
      },
      user_catalogue: {
      ...
      vendors: {
        get: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/vendor/company`,
        create: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/vendor/company`,
        show: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/vendor/company/${context.vendor_id}`,
        update: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/vendor/company/${context.vendor_id}`,
        delete: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/vendor/company/${context.vendor_id}`,
        address_map: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/vendor/company/${context.vendor_id}/address-map`,
        operational_time: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/vendor/operational-time`,
      ...
      paylater_company: {
        get: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/paylater/company`,
        ...
        update_status: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/paylater/company/update-status/${context.company_id}`,
        list: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/paylater/group`,
      },
      paylater_panel: {
        get: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/paylater/panel`,
        get_mitra: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/paylater/panel/mitra/list`,
        get_src: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/paylater/panel/src/list`,
        check_panel: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/paylater/panel/check`,
      ...
      b2b_voucher: {
        ...
        list_retailer: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/voucher/panel/retailer`,
        list_mitra: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/voucher/panel/mitra`,
        ...
        export_panel: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/voucher/panel/export`,
        import_panel: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/voucher/panel/import`,
        preview_import: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/voucher/panel/preview`,
        ...
        listVoucherB2C: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/b2c/voucher/list/data`,
        change_status: `${AYO_API_SERVICE(SERVER.order)}/api/v1/order/principal/voucher/${context.voucher_id}/status`
      },
      medalBadge: {
        medal: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/medal`,
        putMedal: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/medal/${context.id}`,
        retailerList: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/medal/list/retailer`,
        medalCategory: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/medal/list/category`,
        exportRetailer: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/medal/list/retailer/export`,
        importRetailer: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/medal/list/retailer/import`,
        previewImportRetailer: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/medal/list/retailer/preview-import`,
      },
      panel_partnership: {
        get: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/panel-partnership/partnership`,
      ...
      b2c_voucher: {
        //Detail
        getListVoucher: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/b2c/voucher`,
        getDetailVoucher: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/b2c/voucher/${context.voucher_id}`,
        createVoucher: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/b2c/voucher`,
        updateVoucher: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/b2c/voucher/${context.voucher_id}`,
        deleteVoucher: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/b2c/voucher/${context.voucher_id}`,
        getListReimbursement: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/b2c/voucher/reimburse/list`,
        exportListReimbursement: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/b2c/voucher/reimburse/list/export`,

        //Panel
        getSelectedRetailerPanel: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/b2c/voucher/panel/${context.voucher_id}/retailer`,
        getSelectedCustomerPanel: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/b2c/voucher/panel/${context.voucher_id}/customer`,
        updatePanel: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/b2c/voucher/panel/${context.voucher_id}`,

        //Pertukaran Voucher
        getNominal: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/b2c/voucher/reimburse/nominal`,
        updatePenukaranVoucher: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/b2c/voucher/reimburse/${context.voucher_id}`,

        //Design Voucher
        updateDesign: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/b2c/voucher/design/${context.voucher_id}`,

        //Preview VOucher
        updateStatus: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/b2c/voucher/${context.voucher_id}/update-status`,

        //List Detail Voucher
        getListDetailVoucher: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/b2c/voucher/${context.voucher_id}/list`,
        exportListDetailVoucher: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/${type_api}/b2c/voucher/${context.voucher_id}/list/export`,
      ...
      b2b_voucher_inject: {
        ...
        panelRetailerList: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/voucher/inject/panel/retailer`,
        panelMitraList: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/voucher/inject/panel/mitra`,
        panelPreviewImport: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/voucher/inject/panel/preview`,
        panelImport: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/voucher/inject/panel/import`,
        panelExport: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/voucher/inject/panel/export`,
      ...
      customer_care: {
        questions: `${AYO_API_SERVICE(SERVER.business)}/api/v2/business/principal/customer-care/pertanyaan-verifikasi-agent/list`,
