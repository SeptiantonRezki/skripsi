  ...
  getUrl(namespace, key, context) {
    ...
    const ENDPOINT = {
      ...
      schedule_trade_program: {
        ...
        list_tp: `${AYO_API_SERVICE(SERVER.task)}/api/v1/task/${type_api}/creator?page=all`,
        list_template: `${AYO_API_SERVICE(SERVER.task)}/api/v1/task/${type_api}/template?page=all`,
