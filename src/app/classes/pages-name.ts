...
export class PagesName {
  getPages(name) {
    const PAGES = {
      ...
      "/loyalty-keping/redeems": "principal.penukaran_keping.lihat",
      "/loyalty-keping/sources": "principal.riwayat_keping.lihat",
      "/loyalty-keping/settings/stars": "principal.pengaturan_keping.lihat",
      "/loyalty-keping/settings/coo": "principal.pengaturan_keping.lihat",
      "/loyalty-keping/settings/cashier": "principal.pengaturan_keping.lihat",
