...
export class PagesName {
  getPages(name) {
    const PAGES = {
      ...
      "/dte/sub-group-trade": "principal.dtesubgrouptradeprogram.lihat",
      "/dte/sub-group-trade/create": "principal.dtesubgrouptradeprogram.buat",
      "/dte/sub-group-trade/edit/": "principal.dtesubgrouptradeprogram.ubah",
      "/dte/sub-group-trade/detail/": "principal.dtesubgrouptradeprogram.lihat",
