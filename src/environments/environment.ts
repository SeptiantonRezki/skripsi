export const environment = {
  ...
  SRC_KATALOG_KOIN_BASE_IFRAME_URL: 'https://hms-react.ayo-micro.dxtr.asia/src-katalog-koin'
  // SRC_KATALOG_KOIN_BASE_IFRAME_URL: 'http://localhost:3000/src-katalog-koin'
};
